...
urlpatterns = [
    path('get-articles/', ArticleManager.get_articles),
    path("search-articles-published/", SearchUtil.search_published_articles),
    path("search-articles-unpublished/", SearchUtil.search_un_published_articles),
