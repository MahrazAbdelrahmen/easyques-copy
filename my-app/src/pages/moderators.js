...
//    
  ...
  const users = moderators.map((moderateur) => ({
    ...
    first_name: moderateur.first_name,

    last_name: moderateur.last_name,
  ...
  const handleConfirmDelete = async (deletingUserId) => {

    try {  

      await axios.delete(`http://localhost:8000/moderator/ModerateurManager/${deletingUserId}/`);
  ...
  const handleSearchChange = (e) => {
    ...
    const filteredUsers = users.filter(user =>
      ...
      user.last_name.toLowerCase().includes(newValue.toLowerCase())
    ...
    <div className="admin">
              ...
              {editingUser && editUserId === user.id && (
                ...
                <div className="edit-form">
                  ...
                  <EditForm
                    ...
                    initialData={{ first_name: editingUser.first_name ,last_name:editUserId.last_name, email: editingUser.title }}
      ...
      <div className="confirmation-modal">
        ...
        <div className="confirmation-buttons">
          ...
          <button className="delete-yes"onClick={() => handleConfirmDelete(deletingUserId)}>Delete</button>
